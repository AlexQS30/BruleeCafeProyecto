...
public class LoginUI extends javax.swing.JFrame {
    ...
    // La UI usa la Fachada para interactuar con la lógica de negocio.
    ...
    public void validar() {
        ...
        if (!"".equals(correo) || !"".equals(pass)) {
            ...
            ModeloUsuario modeloUsuario = facade.autenticarUsuario(usuario, contrasena);
            // La UI delega la validación a la fachada. No sabe cómo se hace.
            if (null != modeloUsuario) {
                Sistema sis = new Sistema(modeloUsuario);
                sis.setVisible(true);
                this.dispose();
            } else {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 50, 240, 350));

        jPanel1.setBackground(new java.awt.Color(102, 102, 102));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/logo_170x170.png"))); // NOI18N

        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Clientes.png"))); // NOI18N
        jLabel9.setText("Llacma Rojas, Edgar Kevin");

        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Clientes.png"))); // NOI18N
        jLabel10.setText("Quisquiche Siccha, Alex Adderly");

        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Clientes.png"))); // NOI18N
        jLabel11.setText("Cabrales Castillo, Nicole Jazmin ");
        ...
        jLabel14.setText("Ing. Hernan Robalino Gomez");
        ...
        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Clientes.png"))); // NOI18N
        jLabel16.setText("Ramos Inchuña, Luis Angel");

        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Clientes.png"))); // NOI18N
        jLabel17.setText("Quesada Salvatierra, Roberth Antonny");
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 0, 330, -1));
